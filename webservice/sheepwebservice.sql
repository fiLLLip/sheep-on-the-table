...
--
-- Host: localhost
-- Generation Time: Nov 19, 2012 at 07:12 PM
...
--
CREATE DATABASE `knutela_sheep` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `knutela_sheep`;
...
DROP TABLE IF EXISTS `sheep_farm`;
...
DROP TABLE IF EXISTS `sheep_permissions`;
...
DROP TABLE IF EXISTS `sheep_sheep`;
...
DROP TABLE IF EXISTS `sheep_updates`;
